...
class Persona:
    ...
    def full_system_prompt(self) -> str:
        ...
        parts = [
            self.system_prompt,
            ("\nПримеры характерного тона и любимых тем (это ОРИЕНТИР по стилю, "
             "а НЕ готовые ответы — НЕ цитируй их дословно и НЕ повторяй одну и "
             "ту же фразу из раза в раз; каждый раз формулируй заново):\n") +
            ...
            ("\nКАК ПИСАТЬ (живость важнее всего): ты — живой человек в чате, "
             ...
             "балаболкой. НЕ объясняй свой характер, НЕ описывай свои действия "
            ...
            ("\nФорматирование: отвечай как обычное сообщение в чате, без "
             ...
             "оборачивай ответ в теги спойлера, пиши обычным текстом. "
             "Пиши строго по-русски: не вставляй английские слова, латиницу, "
             "roleplay-команды или служебные пояснения, если это не каноническое "
             "имя, аббревиатура или цитата из контекста."),
        ]
        return "\n".join(parts)
