    ...
    def full_system_prompt(self) -> str:
        ...
        parts = [
            ...
            ("\nКАК ПИСАТЬ (живость важнее всего): ты — живой человек в чате, "
             ...
             "по вкусу. НЕ объясняй свой характер, НЕ описывай свои действия "
            ...
            ("\nФорматирование: отвечай как обычное сообщение в чате, без "
             ...
             "«ТЫ»), скажи иначе, новыми словами — повторяться нельзя. Если "
             "раскрываешь событие сюжета после главы %d — оберни ВЕСЬ ответ в "
